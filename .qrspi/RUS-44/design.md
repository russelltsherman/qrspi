...
- **No modifications** to existing files. Integration into the QRSPI workflow, any SKILL, or existing scripts is explicitly out of scope (ref: ticket out-of-scope).
